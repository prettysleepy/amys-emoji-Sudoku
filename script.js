...
document.getElementById('randomizeEmojis').addEventListener('click', () => {
  ...
  renderEmojiChooser();
  message.textContent = 'Great set — click Submit & Start Playing to begin.';
});
...
function toggleEmoji(emoji) {
  ...
  message.textContent = selectedEmojis.length === 9 ? 'Ready — click Submit & Start Playing.' : 'Choose exactly 9 emojis.';
  renderEmojiChooser();
}
